...
/**
 * REST controller for managing {@link com.roadmap.myapp.domain.Contato}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ContatoResource {
    ...
    public ResponseEntity<Contato> updateContato(@PathVariable(value = "id", required = false) final Long id, @RequestBody Contato contato)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, contato.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Contato> partialUpdateContato(
        ...
        Optional<Contato> result = contatoRepository
            ...
            .map(existingContato -> {
                if (contato.getName() != null) {
                    existingContato.setName(contato.getName());
                }
                if (contato.getFone() != null) {
                    existingContato.setFone(contato.getFone());
                }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, contato.getId().toString())
        );
    }
