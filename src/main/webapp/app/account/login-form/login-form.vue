    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        <b-alert show data-cy="loginError" variant="danger" v-if="authenticationError"
          ><strong>Erro de autenticação!</strong> Por favor verifique suas credenciais e tente novamente.</b-alert
        >
      </div>
      <div class="col-md-8">
        <b-form role="form" v-on:submit.prevent="doLogin()">
          <b-form-group label="Username" label="Usuário" label-for="username">
            <b-form-input
              id="username"
              type="text"
              name="username"
          ...
          <b-form-group label="Password" label="Senha" label-for="password">
            <b-form-input
              id="password"
              type="password"
              name="password"
